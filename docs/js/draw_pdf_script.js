...
const newLayers = document.getElementsByClassName("newLayer");
const pencils = document.getElementsByClassName("pencil");
...
for (let d = 0; d < newLayers.length; d++) {
    newLayers[d].addEventListener("click", function() {
        resetAllModes();
        addLayer = true;
    }, false);
}
